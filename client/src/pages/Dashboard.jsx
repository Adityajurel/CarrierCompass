...
function Dashboard() {
  ...
  const [analysis, setAnalysis] = useState(user?.resumeAnalysis || null);
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mb-8">
          ...
          <p className="mt-2 max-w-3xl text-slate-400">
            Analyze your resume, improve your career profile and find colleges
            ...
            <div className="flex h-full flex-col justify-between">
              ...
              <div>
                ...
                <p className="mt-3 leading-7 text-slate-400">
                  Upload your resume and get an AI-powered analysis including
                  ATS score, skills, missing skills, career recommendations,
                  learning roadmap and interview preparation.
                </p>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <a href="#resume-section">
                  <Button>
                    {resumeUrl ? "View Resume" : "Upload Resume"}
                  </Button>
                </a>
          ...
          <Card className="border border-cyan-500/30 bg-gradient-to-br from-slate-900 to-cyan-950/30">
            <div className="flex h-full flex-col justify-between">
              ...
              <div>
                ...
                <p className="mt-3 leading-7 text-slate-400">
                  Enter your JEE or NEET rank, category, quota and preferences
                  to discover colleges you may be eligible for.
                </p>
              </div>
        ...
        {/* ================= RESUME DASHBOARD ================= */}
        <section id="resume-section" className="mb-12 scroll-mt-8">
          ...
          <div className="mb-6">
            ...
            <p className="mt-2 text-slate-400">
              Manage your resume and explore personalized AI recommendations.
            </p>
          </div>
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Understand how your resume performs against applicant tracking
                systems.
              </p>
            </Card>
            ...
            <Card>
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Get AI-generated insights about your resume, profile and career
                readiness.
              </p>
            </Card>
            ...
            <Card>
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Identify important skills you should develop for your target
                career.
              </p>
            </Card>
            ...
            <Card>
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Discover career directions based on your current skills and
                resume.
              </p>
            </Card>
            ...
            <Card>
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Get a personalized direction for the skills and technologies
            ...
            <Card>
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Explore college possibilities using your rank, category and
          ...
          <Card>
            ...
            <div className="grid gap-7 md:grid-cols-4">
              ...
              {[
                ...
                ["3", "Understand", "See your score, strengths and skill gaps."],
                ["4", "Improve", "Follow recommendations and build your career."],
        ...
        <section className="mb-12 grid gap-6 md:grid-cols-2">
          ...
          <Card>
            ...
            <p className="mt-4 leading-7 text-slate-400">
              CareerCompass AI helps students and job seekers understand their
              current profile, improve their resumes, identify skill gaps and
              make better career decisions.
            </p>

            <p className="mt-3 leading-7 text-slate-400">
              The goal is simple: understand where you are, where you can go
          ...
          <Card>
            ...
            <div className="mt-5 space-y-5">
              ...
              <div>
                <h3 className="font-semibold">🚀 Career Explorers</h3>
                <p className="mt-1 text-sm text-slate-400">
                  Understand your strengths and discover possible career
                  directions.
                </p>
              </div>
          ...
          <Card>
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl leading-7 text-slate-400">
                CareerCompass AI combines a modern web application with
                artificial intelligence to provide practical career and
                education guidance.
              </p>
